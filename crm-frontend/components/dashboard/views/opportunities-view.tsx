...
import { fetchDashboardOpportunities, fetchPipelineStages, fetchAvgSalesCycle } from "@/lib/dashboard-queries";
...
export default function OpportunitiesView({ filters }: { filters: Filters }) {
  ...
  const loading = loadingOpps || loadingStages || loadingCycle;
