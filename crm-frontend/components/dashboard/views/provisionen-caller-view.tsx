...
import { fetchCallerProvisionTransactions } from "@/lib/dashboard-queries";
...
export default function ProvisionenCallerView({ filters }: { filters: Filters }) {
  ...
  const { data: txns, loading, error } = useDashboardQuery(fetchCallerProvisionTransactions, filters);
